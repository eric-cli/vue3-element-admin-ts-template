  ...
  <div class="login-container">
    ...
    >
      ...
      <el-row class="form-btns" justify="space-around">
        <el-button :loading="loading" @click.prevent="resetForm(loginFormRef)">Reset</el-button>
        <el-button :loading="loading" type="primary" @click.prevent="submitForm(loginFormRef)"
          >Login</el-button
        >
      </el-row>
